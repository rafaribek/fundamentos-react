import { Card, ColorPalette, Flex, FormatNumber, FormatNumberProps, Icon, Stat } from "@chakra-ui/react";
...
export function IndicatorCard({ icon, label, value, indicator, colorPallete, ...rest }: IndicatorCardProps) {
